...
Config :: struct {
	...
	// Set to true translate type names to snake_case
	force_snake_case_types: bool,

	// Set to true translate type names to camelCase
	force_camel_case_types: bool,

	// Set to true translate type names to PascalCase
	force_pascal_case_types: bool,
